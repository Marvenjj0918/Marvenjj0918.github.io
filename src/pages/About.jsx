  ...
  return (
    <div className="body" data-new-gr-c-s-check-loaded="14.1047.0" data-gr-ext-installed>
      ...
      <div className="name">
        ...
        <h1>Inspirational Personal Website I appreciate</h1>
        <ol>
          <li>
            <a href="http://brandoncjohnson.com/">Brandonc Johnson</a>
          </li>
          <li>
            <a href="https://www.juliaundeutsch.com/">Julia Undeutsch</a>
          </li>
          <li>
            <a href="https://www.stevenmholl.com/">Steven M. Holl</a>
          </li>
        </ol>
      </div>
    </div>
